  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center p-6 bg-gradient-to-br from-primary-50 via-white to-accent-50">
      ...
      <p className="text-gray-500 mb-8 text-center max-w-xs">
        Track your projects, investors, and fund allocations in one place
      </p>
      <button
        onClick={loginWithGoogle}
        className="flex items-center gap-3 bg-white border border-gray-200 hover:border-gray-300 hover:shadow-md px-6 py-3 rounded-2xl font-medium text-gray-700 transition-all duration-200 active:scale-95"
      >
